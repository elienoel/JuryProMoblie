...
import 'package:app_jury/components/CandidateEtGroupCard/CandidateCard.dart';
                    ...
                    children: <Widget>[
                      RaisedButton(
                        onPressed: () {
                          int id;
                          setState(() {
                            _readEvent = Request.createOrUpdateEvent(id,
                        ...
                        children: <Widget>[
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 5, vertical: 5),
                            child: Text(
                              "Du ${snapshot.data.dateDebut} au ${snapshot.data.dateFin})",
                              style: TextStyle(
                                fontSize: 16,
                                color: Colors.grey,
                              ),
